...
from lib.borrowBookDialog import borrowBookDialog
from lib.returnBookDialog import returnBookDialog
from lib.BorrowStatusViewer import BorrowStatusViewer
...
class StudentHome(QWidget):
    def __init__(self, studentId):
        ...
        studentName = Library.ExecQuery(f"SELECT rdName FROM TB_Reader WHERE rdId={self.StudentId}")
        self.StudentName = studentName[0][0]
    ...
    def borrowBookButtonClicked(self):
        borrowDialog = borrowBookDialog(self.StudentId,self.StudentName,self)
    ...
    def returnBookButtonClicked(self):
        returnDialog = returnBookDialog(self.StudentId,self.StudentName,self)
