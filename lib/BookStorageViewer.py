...
class BookStorageViewer(QWidget):
    ...
    def setUpUI(self):
        ...
        self.queryModel = QStandardItemModel(14,10)
    ...
    def getTotalRecordCount(self):
        ...
        result = Library.ExecQuery("SELECT * FROM TB_Book")
        countResult = Library.ExecQuery("SELECT COUNT(*) FROM TB_Book")
        if result != []:
    ...
    def recordQuery(self, index):
        ...
        if (self.searchEdit.text() == ""):
            ...
            countQueryCondition = "SELECT COUNT(*) FROM TB_Book"
        ...
        countQueryCondition = (f"SELECT * FROM TB_Book WHERE {conditionChoice} LIKE '%{temp}%' ORDER BY {conditionChoice} ")
